...
const PACKAGES = [
  ...
  'plugin-yaml', 'plugin-cli', 'plugin-loop', 'plugin-use', 'plugin-data', 'plugin-assert', 'plugin-json', 'plugin-junit', 'plugin-http', 'plugin-playwright', 'plugin-gate', 'plugin-allure', 'plugin-html', 'plugin-ui',
